...
const HeroSection = () => {
  ...
  return (
    ...
    bg-cover bg-center h-screen'>
      ...
      <p className='max-w-md text-gray-300'>In a post-apacalyptic world where cities ride on wheels and
         consume each other to survive, two people meet in the London and try to stop
         a conspiracy.</p>
