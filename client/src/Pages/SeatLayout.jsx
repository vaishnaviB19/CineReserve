  ...
  const bookTickets = async ()=>{
    try {
      if(!user) return toast.error('Please login to proceed')
        if(!selectedTime || !selectedSeats.length) return toast.error("Please select the time and seats");

      const {data} = await axios.post('/api/bookings/create', {showId:
        selectedTime.showId, selectedSeats},{ headers: {
