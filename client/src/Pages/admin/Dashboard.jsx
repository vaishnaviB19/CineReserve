...
const Dashboard = () => {
  ...
  const dashboardcard=[
    {title:'Total Bookings', value: currency + dashboardData.totalBookings || '0', icon:
      ChartLineIcon },
    {title:'Total Revenue', value: dashboardData.totalRevenue || '0', icon:
      ...
      <div className='relative flex flex-wrap gap-4 mt-6'>
        ...
        <div className='flex flex-wrap gap-4 w-full'>
         {dashboardcard.map((card,index)=>(
          ...
          px-4 py-3 bg-primary/10 border border-primary/20 rounded-md 
          max-w-50 w-full'>
            <div>
